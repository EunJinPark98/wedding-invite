 ...
 *   연주     — FluidR3_GM 사운드폰트의 악기 샘플로 직접 연주해 구웠다.
 *              시중 음반을 가져다 쓴 것이 아니라 연주자·음반사 권리가
 *              걸리지 않는다.
 * 악기는 곡마다 다르다 — 오르골·첼레스타·피아노·하프·현악.
 *
 * ※ FluidR3_GM 은 CC BY 3.0 이라 "출처 표기"가 의무다. 이용약관 제5조에
 *   출처와 라이선스 링크를 적어 두었으니 (src/app/terms/page.tsx) 곡을
 *   더하거나 사운드폰트를 바꿀 때 그 문구도 함께 손봐야 한다.
 *
