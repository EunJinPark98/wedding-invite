...
export const metadata: Metadata = {
  title: {
    default: "별빛 초대장 — 모바일 청첩장 · 돌잔치 · 칠순 · 생일 초대장 만들기",
    template: "%s | 별빛 초대장",
  },
  description:
    "별처럼 빛나는 순간, 마음을 담은 초대장으로. 결혼 청첩장부터 돌잔치·칠순·팔순·생일 초대장까지, 템플릿을 고르고 내용을 입력해 나만의 모바일 초대장을 만들고 링크로 공유하세요. 결혼·육아·가족을 위한 웹서비스, 별마마파파.",
